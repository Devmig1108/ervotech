    ...
    return (
        <HelmetProvider>
            <Helmet>
                ...
                <meta property="og:title" content="Insights & Strategy | Ervotech" />
                                        ...
                                        <div className="portfolio-item" style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                                            ...
                                            <div style={{ flexGrow: 1, padding: '2rem', background: 'var(--secondary-dark)', borderRadius: '0 0 12px 12px', border: '1px solid var(--border-subtle)', borderTop: 'none', display: 'flex', flexDirection: 'column' }}>
                                                ...
                                                <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem', lineHeight: '1.4', textAlign: 'left' }}>
                                                    <Link href={`/blog/${blog.slug}`} style={{ color: 'var(--text-1)', textDecoration: 'none' }}>
                                                        {blog.title}
                                                    </Link>
                                                </h2>
                                                <div
                                                    ...
                                                    dangerouslySetInnerHTML={{
                                                        __html: typeof window !== 'undefined'
                                                            ? DOMPurify.sanitize(blog.content.slice(0, 140) + "...")
                                                            : blog.content.slice(0, 140) + "..."
                                                    }}
                                                />
                                                <div style={{ borderTop: '1px solid var(--border-subtle)', paddingTop: '1.5rem', marginTop: 'auto' }}>
                                                    <Link href={`/blog/${blog.slug}`} style={{ color: 'var(--accent-teal)', textDecoration: 'none', fontWeight: 'bold', display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
                                                        Read Article
                                                    </Link>
                                                </div>
                                            </div>
                        ...
                        <div className="container" style={{ maxWidth: '800px', margin: '0 auto' }}>
                            <Fade bottom duration={800}>
                                <div className="audit-box aurora-bg">
                                    <h2 style={{ fontSize: 'clamp(2rem, 4vw, 2.5rem)', marginBottom: '1rem' }}>Apply These Strategies to Your Site.</h2>
                                    <p style={{ color: 'var(--text-2)', marginBottom: '2rem' }}>Stop guessing what works. Drop your website address below, and we'll send you a free technical review.</p>
